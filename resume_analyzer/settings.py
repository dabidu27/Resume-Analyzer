...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': ['rest_framework.permissions.IsAuthenticated'] #we set this permission globally, so every view can be accessed only by authenticated users
